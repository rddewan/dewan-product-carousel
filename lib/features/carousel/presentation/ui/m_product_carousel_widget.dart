...
class MProductCarouselWidget extends StatefulWidget {
  ...
  @override
  State<MProductCarouselWidget> createState() => _MProductCarouselWidgetState();
}

class _MProductCarouselWidgetState extends State<MProductCarouselWidget> {
